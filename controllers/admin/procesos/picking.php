...
function mostrarPicking(){
  if (!$_SESSION["id_empleado"]){
    ...
    adr.city AS ciudad, sta.name AS provincia, col.name AS pais, ord.date_add AS fecha_pedido, car.name AS transporte, ord.module AS 'amazon', ppe.nombre_estado AS 'estado_pickpack', ord.gift AS regalo  
        ...
        foreach ($productos_pedido as $producto) { 
          ...
          echo '
            <div class="col-sm-5 col-xs-6">
              <p class="h6">'.$nombre_producto.'</p><br>
...
function procesaPicking(){
  ...
  if (!$id_empleado){
    ...
    if(isset($_POST['submit_finpicking'])){
      ...
      //16/04/2020 la quitamos para que vuelva directo a inicio de picking
      // echo '
      // <div class="jumbotron jumbotron_picking">
