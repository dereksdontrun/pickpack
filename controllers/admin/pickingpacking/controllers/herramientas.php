...
function infoOrder($id_order){    
  ...
  ord.module AS module, ord.payment AS metodo_pago, osl.name AS estado_prestashop, ppe.nombre_estado AS 'estado_pickpack', ord.gift AS regalo, ord.id_cart AS id_cart, ord.gift_message AS mensaje_regalo, cus.note AS nota_sobre_cliente, cus.id_default_group AS grupo_cliente, adr.phone_mobile AS tlfno1, adr.phone AS tlfno2,
